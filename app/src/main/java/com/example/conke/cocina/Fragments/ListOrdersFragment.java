...
public class ListOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista =  inflater.inflate(R.layout.fragment_list_orders, container, false);
        orders= new ArrayList<>();
        recyclerList= vista.findViewById(R.id.recycler_list);
        recyclerList.setLayoutManager(new LinearLayoutManager(getContext()));
        loadOrders(interfaz.getStoreId());
        listAdapter adapter = new listAdapter(orders);
        adapter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                interfaz.loadOrdersProduct(orders.get(recyclerList.getChildAdapterPosition(v)).getOrderId());
            }
        });
    ...
    private void loadOrders(int storeId) {
        orders.clear();
        SQLQueries queries = new SQLQueries(getContext());
        orders=queries.loadOrderByStoreId(storeId);
    }
